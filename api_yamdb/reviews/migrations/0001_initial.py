# Generated by Django 2.2.16 on 2022-08-07 15:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('user', 'Пользователь'), ('moderator', 'Модератор'), ('admin', 'Администратор')], default='user', max_length=13)),
                ('confirmation_code', models.CharField(default='XXXXXX', max_length=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(db_index=True, null=True, validators=[reviews.validators.validate_year], verbose_name='Год произведения')),
